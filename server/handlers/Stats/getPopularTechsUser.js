...
const options = {
  ...
  // this endpoints gets a list of all techs for games containing the specified :user

  const getPopularTechsUser = async (req,res) => {
...
module.exports = {getPopularTechsUser};