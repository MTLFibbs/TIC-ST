...
const options = {
  ...
  // this endpoints gets a list of all secret objectives for games containing the specified :user

  const getPopularSecretObjectivesUser = async (req,res) => {
...
module.exports = {getPopularSecretObjectivesUser};