...
const options = {
  ...
  // this endpoints gets a list of all techs researched in a game divided within objects in an array

  const getPopularTechs = async (req,res) => {
...
module.exports = {getPopularTechs};