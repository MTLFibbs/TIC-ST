...
const LiveGameCreateForm = ({factions,form,setForm, isFetching, setIsFetching, handleSubmit}) => {
    ...
    return(
        <Wrapper id = "my-form">
            ...
            <StyledInput  onChange = {handleChange} disabled type ="text" name = "host" value = {"Fibbs"} id = "host"/>
            ...
            <GridWrapper>
                <UnitWrappers>
                    ...
                    <StyledInput  onChange = {handleChange} disabled name = "player1" type = "text" value = {"Fibbs"}/>
                    <StyledSelect  onChange = {handleChange} type = "text" name = "faction1" value = {form.faction}>
                            <StyledOption value = "">...</StyledOption>
                        {factions.map((el, i) => {
                            return <StyledOption value = {`${el.nickname}`}>{el.factionName}</StyledOption>
                        })}
                        </StyledSelect>
                </UnitWrappers>
