...
const StatsLanding = () => {
    ...
    const fetchAll = async () => {
        const popularityCount = await fetch(`/api/get-faction-popularity/${user.nickname}`).then((res) => res.json());
        ...
        const victoryCount = await fetch(`/api/get-faction-vp/${user.nickname}`).then((res) => res.json());
        ...
        const countUnit = await fetch(`/api/get-popular-units/${user.nickname}`).then((res) => res.json());
        ...
        const countObjectives = await fetch(`/api/get-popular-objectives/${user.nickname}`).then((res) => res.json());
        ...
        const countSecretObjectives = await fetch(`/api/get-popular-secret-objectives/${user.nickname}`).then((res) => res.json());
        ...
        const countTech = await fetch(`/api/get-popular-techs/${user.nickname}`).then((res) => res.json());
            if(techGlobal.status !== 200){
